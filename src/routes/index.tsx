...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Gama PRESS — Precificação inteligente" },
      { name: "description", content: "Calcule custos, margens e preços ideais sem erros." },
    ],
  }),
  component: Dashboard,
});
...
function Stat({ label, value, hint, icon: Icon, accent }: {
  ...
  return (
    <div className="rounded-2xl border border-border bg-card p-5 shadow-[0_1px_2px_rgba(0,0,0,0.03)]">
